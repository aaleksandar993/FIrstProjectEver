<?=$this->setSiteTitle("Add Candidate");?>
<?=$this->start('head');?>
<?=$this->end('head');?>
<?=$this->start('body');?>
<div class="card">
		...
		<form method="POST" enctype="multipart/form-data" action="/candidate/store" id="candidateCreateForm" class="candidateCreateForm needs-validation">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 py-1">
					...
					<input type="text" name="candidateDrivingLicence" placeholder="A B C D E" class="form-control">
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6 py-1">
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="">
						<input  type="checkbox" class="form-check-inline" id="candidateAgreement" name="candidateAgreement">
